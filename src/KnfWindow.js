				...
				<g id="main">
					...
					<g id="h-measure">
						<path
							...
							d="M ${this.offset_x},${this.offset_y} V ${this
								.offset_y - this.measure_bar_height}"
							id="h-measure-left"
						/>
						<path
							style="fill:none;stroke:#000000;stroke-width:1.0;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
							d="M ${this.offset_x + this.width / 10},${this
								.offset_y} V ${this.offset_y -
							this.measure_bar_height}"
							id="h-measure-right"
						/>
						...
						<path
							...
							d="M ${this.offset_x},${this.offset_y -
							this.measure_bar_height * 0.5} H ${this.offset_x +
							this.width / 10}"
							id="h-measure-line"
						/>
						<text
					...
					<g id="v-measure">
						<path
							style="fill:none;stroke:#000000;stroke-width:1.0;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
							d="M ${this.offset_x},${this.offset_y} H ${this
								.offset_x - this.measure_bar_height}"
							id="v-measure-top"
						/>
						<path
							style="fill:none;stroke:#000000;stroke-width:1.0;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
							d="M ${this.offset_x},${this.offset_y +
							this.height / 10} H ${this.offset_x -
							this.measure_bar_height}"
							id="v-measure-bottom"
						/>
						<path
							...
							d="M ${this.offset_x -
							this.measure_bar_height * 0.5},${this
								.offset_y} v ${this.height / 10}"
							id="v-measure-line"
						/>
						<g
							transform="translate(${this.offset_x}, ${this
								.offset_y}) rotate(-90)"
						>
							<text
								style="font-style:normal;font-variant:normal;font-weight:normal;font-stretch:normal;font-size:10px;line-height:1.25;font-family:monospace;font-variant-ligatures:normal;font-variant-caps:normal;font-variant-numeric:normal;font-variant-east-asian:normal;fill:#000000;fill-opacity:1;stroke:none;stroke-width:0.264583"
